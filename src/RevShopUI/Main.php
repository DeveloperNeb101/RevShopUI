...
"Emerald Block" => [133,0,5000,50],
"Diamond Block" => [57,0,10000,50],
"Glass" => [20,0,50,30],
"Iron Block" => [42,0,3000,30],
...
"ICON" => ["Ores",266,0],
"Coal" => [263,0,25,5],
"Iron Ingot" => [265,0,50,10],
"Gold Ingot" => [266,0,60,20],
"Diamond" => [264,0,300,50],
"Lapis" => [351,4,500,75]
];
public $Tools = [
"ICON" => ["Tools",278,0],
...
public $MobSpawners = [
"ICON" => ["MobSpawners",52,0],
"Blaze Spawner" => [52,43,5000000,1000],
"Skeleton Spawner" => [52,34,500000,1000],
"Zombie" => [52,32,500000,1000],
"Zombie_Pigman Spawner" => [52,36,500000,1000],
"Creeper Spawner" => [52,33,2000000,1000],
"Pig Spawner" => [52,12,300000,1000],
"Spider Spawner" => [52,35,1000000,1000],
"Cow Spawner" => [52,11,200000,1000],
"Iron Golem Spawner" => [52,20,10000000,1000],
...
public $MobDrop = [
"ICON" => ["MobDrop",369,0],
"Blaze Rod" => [369,0,500,35],
"Gold Nuggets" => [371,0,500,25],
"Rotten Flesh" => [367,0,500,15],
...
$this->item = [$this->Banners, $this->MobDrop, $this->Skulls, $this->Potions, $this->MobSpawners, $this->Raiding, $this->Farming, $this->Armor, $this->Tools, $this->Ores, $this->Blocks, $this->Miscellaneous];
}
public function sendMainShop(Player $player){
$ui = new SimpleForm("§l§6Ore§bscape §eShop"," §aPurchase and Sell items Here!");
